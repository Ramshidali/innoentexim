...
class PurchaseParty(BaseModel):
    ...
    image = VersatileImageField('Image', upload_to="purchase_party/profile_pic", blank=True, null=True)
    
    user = models.OneToOneField(User,on_delete=models.CASCADE,blank=True,null=True)
    
    class Meta:
        db_table = 'purchase_party'
        verbose_name = ('Purchase Party')
        verbose_name_plural = ('Purchase Party')
