...
class SalesPartyForm(forms.ModelForm):

    class Meta:
        model = SalesParty
        fields = ['first_name','last_name','email','phone','date_of_birth','gst_no','address','state','country','zip','image']
    ...
    def clean_phone(self):
        ...
        if SalesParty.objects.filter(phone=phone).exists():
